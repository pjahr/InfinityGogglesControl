...
public class ControllerFragment extends ConnectedPeripheralFragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, SensorEventListener, ControllerColorPickerFragment.ControllerColorPickerFragmentListener, ControllerPadFragment.ControllerPadFragmentListener, UartDataManager.UartDataManagerListener
{
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
  {
    ...
    if (context != null)
    {
      ...
      Drawable lineSeparatorDrawable = ContextCompat.getDrawable(context,
                                                                 R.drawable.simpledivideritemdecoration);
      ...
      mControllerAdapter = new ControllerAdapter(context,
                                                 mSensorData,
                                                 new ControllerAdapter.Listener()
                                                 {
                                                   @Override
                                                   public void onSensorEnabled(int sensorId,
                                                                               boolean enabled)
                                                   {
                                                     final Context context = getContext();
                                                     ControllerFragment controllerFragment = weakThis.get();
                                                     if (context == null || controllerFragment == null)
                                                     {
                                                       return;
                                                     }
                                                     ...
                                                     if (sensorId == kSensorType_Location && enabled)
                                                     {
                                                       ...
                                                       {
                                                         final String locationDeniedString = context.getString(
                                                                 R.string.controller_sensor_location_denied);
                                                         new AlertDialog.Builder(context).setMessage(
                                                                 locationDeniedString).setPositiveButton(
                                                                 android.R.string.ok,
                                                                 null).show();
                                                       }
                                                     }
                                                     ...
                                                     controllerFragment.registerEnabledSensorListeners(
                                                             context,
                                                             true);
                                                   }
                                                       ...
                                                       if (fragmentManager != null)
                                                       {
                                                         ...
                                                         switch (moduleId)
                                                         {
                                                           case kModule_ControlPad:
                                                             ...
                                                             mWeakControllerPadFragment = new WeakReference<>(
                                                                     controllerPadFragment);
                                                             mUartDataManager.clearRxCache(
                                                                     mBlePeripheral.getIdentifier());
                                                             mUartDataManager.setListener(
                                                                     ControllerFragment.this);
                                                             break;
                                                         ...
                                                         if (fragment != null)
                                                         {
                                                           ...
                                                           FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction().setCustomAnimations(
                                                                   ...
                                                                   R.anim.slide_out_left).replace(R.id.contentLayout,
                                                                                                  fragment,
                                                                                                  fragmentTag);
      ...
      { // Only the first time
        ...
        // Setup
        mUartDataManager = new UartDataManager(context,
                                               null,
                                               false);            // The listener will be set only for ControlPad
        setupUart();
      }
    }
  }
  ...
  public void onResume()
  {
    ...
    if (resultCode == ConnectionResult.SERVICE_MISSING || resultCode == ConnectionResult.SERVICE_VERSION_UPDATE_REQUIRED || resultCode == ConnectionResult.SERVICE_DISABLED)
    {
      ...
      Dialog googlePlayErrorDialog = apiAvailability.getErrorDialog(getActivity(),
                                                                    resultCode,
                                                                    MainActivity.kActivityRequestCode_PlayServicesAvailability);
    ...
    mBlePeripheralUart.uartEnable(mUartDataManager, status -> mMainHandler.post(() ->
                                                                                {
                                                                                  ...
                                                                                  {
                                                                                    WeakReference<BlePeripheralUart> weakBlePeripheralUart = new WeakReference<>(
                                                                                            mBlePeripheralUart);
                                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(
                                                                                            getContext());
                                                                                    AlertDialog dialog = builder.setMessage(
                                                                                            R.string.uart_error_peripheralinit).setPositiveButton(
                                                                                            android.R.string.ok,
                                                                                    ...
                                                                                    DialogUtils.keepDialogOnOrientationChanges(
                                                                                            dialog);
                                                                                  }
                                                                                }));
  }
    ...
    switch (item.getItemId())
    {
      case R.id.action_help:
        if (activity != null)
        {
          ...
          if (fragmentManager != null)
          {
            CommonHelpFragment helpFragment = CommonHelpFragment.newInstance(getString(R.string.controller_help_title),
                                                                             getString(R.string.controller_help_text));
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction().setCustomAnimations(
                    R.anim.slide_in_left,
                    R.anim.slide_out_right,
                    R.anim.slide_in_right,
                    R.anim.slide_out_left).replace(R.id.contentLayout, helpFragment, "Help");
            fragmentTransaction.addToBackStack(null);
        ...
        mFusedLocationClient.getLastLocation().addOnSuccessListener(location ->
                                                                    {
                                                                      ...
                                                                      if (location != null)
                                                                      {
                                                                        ...
                                                                        mMainHandler.post(() -> setLastLocation(
                                                                                location));
                                                                      }
                                                                    });
  ...
  private boolean requestFineLocationPermissionIfNeeded()
  {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
    {
      ...
      if (context.checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED)
      {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
        mRequestLocationDialog = builder.setTitle(R.string.bluetooth_locationpermission_title).setMessage(
                R.string.controller_sensor_locationpermission_text).setPositiveButton(android.R.string.ok,
                                                                                      null).setOnDismissListener(
                dialog -> requestPermissions(new String[]{Manifest.permission.ACCESS_FINE_LOCATION},
                                             MainActivity.PERMISSION_REQUEST_FINE_LOCATION)).show();
      }
    }
  ...
  {
    if (mUartDataManager == null)
    {     // Check because crash found on logs (mUartDataManager is null)
      return;
    }
  ...
  private void registerEnabledSensorListeners(@NonNull Context context, boolean register)
  {
    ...
    if (mSensorManager != null)
    {       // Check not null (crash detected when app is resumed and device has been disconnected and onDestroy tries to remove sensor manager listeners)
      // Accelerometer
      ...
      if (register && (mSensorData[kSensorType_Magnetometer].enabled || mSensorData[kSensorType_Quaternion].enabled))
      {
        ...
        {
          new AlertDialog.Builder(context).setMessage(getString(R.string.controller_magnetometermissing)).setPositiveButton(
                  android.R.string.ok,
                  null).show();
  ...
  {
    // Config
    private static final int[] kSensorTitleKeys = {
            R.string.controller_sensor_quaternion,
            R.string.controller_sensor_accelerometer,
            R.string.controller_sensor_gyro,
            R.string.controller_sensor_magnetometer,
    ...
    ControllerAdapter(@NonNull Context context,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
      switch (viewType)
      {
        ...
        {
          View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_common_section_item,
                                                                       parent,
                                                                       false);
        ...
        {
          View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_controller_sensordata_item,
                                                                       parent,
                                                                       false);
        ...
        {
          View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_common_textview_item,
                                                                       parent,
                                                                       false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position)
    {
      ...
      switch (viewType)
      {
        case kCellType_SectionTitle:
          ...
          sectionViewHolder.titleTextView.setText(localizationManager.getString(mContext,
                                                                                "pinio_pins_header"));
          break;
        case kCellType_SensorDataCell:
            ...
            else
            {
              for (int i = 0; i < sensorDataViewHolder.textViews.length; i++)
              {
                ...
                if (isDefined)
                {
                  ...
                  {
                    final int[] prefixId = {
                            R.string.controller_component_lat,
                            R.string.controller_component_long,
                            R.string.controller_component_alt
                    };
                  ...
                  {
                    final int[] prefixId = {
                            R.string.controller_component_x,
                            R.string.controller_component_y,
                            R.string.controller_component_z,
                            R.string.controller_component_w
                    };
                    valueString = mContext.getString(prefixId[i]) + ":\t " + sensorData.values[i];
                  }
                }
